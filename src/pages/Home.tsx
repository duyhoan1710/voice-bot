...
import { Model3D } from "../commons/Model3D";
...
enum EMode {
  "_1" = "/models/model_dancing.fbx",
  "_2" = "/models/model2_raise_hand.fbx",
}
...
function Home() {
  ...
  const [fileNameModel, setFileNameModel] = useState<string>(EMode._1);
    ...
    <div className="App" ref={containerRef}>
      ...
      <div className="body h-body flex px-5 pb-4">
        <div className="lg:w-1/4 flex flex-col items-center">
          <Model3D fileName={fileNameModel} key={fileNameModel} />

          <label className="relative inline-flex items-center cursor-pointer m-3">
            <input
              onChange={(e) =>
                !e.target.checked
                  ? setFileNameModel(EMode._1)
                  : setFileNameModel(EMode._2)
              }
              type="checkbox"
              value=""
